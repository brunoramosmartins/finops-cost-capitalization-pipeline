#!/usr/bin/env python
"""Generate synthetic billing data and persist it to the local mock lake."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", default="conf/generator_profiles.yml", help="Path to the generator profile YAML file.")
    parser.add_argument("--profile", default="default", help="Profile name inside the YAML config.")
    parser.add_argument("--days", type=int, default=None, help="Override the configured number of days to generate.")
    parser.add_argument("--seed", type=int, default=None, help="Override the configured random seed.")
    parser.add_argument("--run-date", default=None, help="Override the configured run date in ISO format (YYYY-MM-DD).")
    parser.add_argument(
        "--output-format",
        choices=["parquet", "csv"],
        default=None,
    ...
    parser.add_argument("--sample-size", type=int, default=None, help="Number of rows to write into the sample CSV.")
...
def build_generation_config(args: argparse.Namespace) -> tuple[GenerationConfig, str, int]:
    """Build the runtime generation config plus persistence options."""
